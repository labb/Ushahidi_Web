										...
										<div class="box">
											<label>
												<?php
													...
													print form::checkbox('alert_email_yes', '1', $checked);
												?>
												<span><strong><?php echo Kohana::lang('ui_main.alerts_att'); ?></strong><br /><?php echo Kohana::lang('ui_main.alerts_enter_att'); ?></span>
											</label>
											<span><?php print form::input('alert_email', $form['alert_email'], ' class="text long"'); ?></span>
										</div>
...
<div class="box">
											<label>
												<?php
													...
													print form::checkbox('alert_email_yes', '1', $checked);
												?>
												<span><strong><?php echo Kohana::lang('ui_main.alerts_sprint'); ?></strong><br /><?php echo Kohana::lang('ui_main.alerts_enter_sprint'); ?></span>
											</label>
											<span><?php print form::input('alert_email', $form['alert_email'], ' class="text long"'); ?></span>
										</div>
										...
										<div class="box">
											<label>
												<?php
													...
													print form::checkbox('alert_email_yes', '1', $checked);
												?>
												<span><strong><?php echo Kohana::lang('ui_main.alerts_tmobile'); ?></strong><br /><?php echo Kohana::lang('ui_main.alerts_enter_tmobile'); ?></span>
											</label>
											<span><?php print form::input('alert_email', $form['alert_email'], ' class="text long"'); ?></span>
										</div>
										...
										<div class="box">
											<label>
												<?php
													...
													print form::checkbox('alert_email_yes', '1', $checked);
												?>
												<span><strong><?php echo Kohana::lang('ui_main.alerts_verizon'); ?></strong><br /><?php echo Kohana::lang('ui_main.alerts_enter_verizon'); ?></span>
											</label>
											<span><?php print form::input('alert_email', $form['alert_email'], ' class="text long"'); ?></span>
										</div>
