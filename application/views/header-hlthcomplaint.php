...
<!-- submit incident -->
			...
			<!-- / DONATEsubmit incident -->

<!-- submit incident -->
			<div class="submit-incident clearingfix" align="center">
				<a href="https://npo.networkforgood.org/Donate/Donate.aspx?npoSubscriptionId=1002791">Donate</a>
			</div>
			<!-- / DONATEsubmit incident -->
<div class="logo"><h3>Health Complaint?</h3>
If you have a health complaint related to the oil spill, contact the Louisiana Poison Center: 1-800-222-1222.  The Poison Center is staffed 24-hours a day and can provide medical management advice. </div>
...
<input type="submit" name="b" class="searchbtn" value="search reports" /><input type="text" name="k" value="" class="text" /></form>
<a class="button btn_download" href="<?php echo url::base() . 'download/'; ?>"><font color="black"><strong>  |  Download reports</strong></font></a>
<a id="reports-rss" class="button btn_rss" href="<?php echo url::base() . 'feed/'; ?>"><font color="black"><strong> | Reports RSS </strong></font></a>
